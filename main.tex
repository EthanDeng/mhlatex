...
声明文类使用 \mintinline{tex}{\documentclass[文类选项]{文类}}，注意，文类的声明可以带可选项。以文类 \texmint{article} 为例，由于 \texmint{article} 的默认纸张为 legal 大小，将其更改为 A4 纸张，需要使用 \mintinline{tex}{\documentclass[a4paper]{article}}。我们也可以通过文类选项设置字体大小，比如正文字体大小为 11pt 的设置为 \mintinline{tex}{\documentclass[a4paper,11pt]{article}}
